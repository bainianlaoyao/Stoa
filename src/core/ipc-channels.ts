export const IPC_CHANNELS = {
  ...
  hermesProposalList: 'hermes:proposal-list',
  hermesProposalGet: 'hermes:proposal-get',
  hermesProposalApprove: 'hermes:proposal-approve',
  hermesProposalReject: 'hermes:proposal-reject',
  hermesProposalDispatch: 'hermes:proposal-dispatch',
  hermesInspectorSetTarget: 'hermes:inspector-set-target',
