/**
 * Hook event adapter service — converts raw provider hook payloads into
 * CanonicalSessionEvent objects. Ported from src/core/hook-event-adapter.ts
 * as part of Phase 2b (webhook routes migration).
 */
import { randomUUID } from 'node:crypto'
import type { CanonicalSessionEvent } from 'stoa-shared'
import type { MemoryRuntimeEvidence, MemoryRuntimeEvidenceProvider } from 'stoa-shared'
