/**
 * SessionSupervisor — Stoa Server side.
 *
 * Extracted from src/core/session-supervisor.ts as part of Phase 2b
 * (Express → Hono migration). All business logic preserved verbatim;
 * only structural changes for constructor injection.
 */
import { derivePresencePhase } from 'stoa-shared'
import {
