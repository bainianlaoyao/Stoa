...
describe('playwright skeleton generator', () => {
  ...
  it('generates a deterministic Claude lifecycle skeleton', () => {
    ...
    expect(generated).toContain("'session.presence.failure'")
    ...
    expect(generated).toContain("data-session-status-testid', 'session-status-failure'")
  ...
  it('generates a deterministic mobile UI V1 skeleton', () => {
    ...
    expect(generated).toContain("app.page.getByTestId('terminal-shell')).toHaveCSS('min-width', '960px')")
    ...
    expect(generated).toContain("app.page.getByTestId('mobile-session-actions-sheet')).not.toContainText('Display')")
    expect(generated).toContain("app.page.getByTestId('mobile-shell')).toBeVisible()")
